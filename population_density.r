...
pop %>%
  ...
  plot_3d(pop, zscale = 100, solid = FALSE,shadowdepth = 0.3, windowsize = c(1800,900), theta = 0,zoom=0.4)
render_highquality(camera_lookat = c(0,-80,0), light=0.8, filename = "global_population_density.png", rotate_env=180,title_text = "Global Population Density \n Nathanael Sheehan", title_color = "white",ground_material = rayrender::diffuse(color = "lawngreen"))
